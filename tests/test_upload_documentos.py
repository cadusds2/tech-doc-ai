...
class ServicoIngestaoNaoUtilizado:
    def registrar_documento_recebido(self, _nome_arquivo: str, _conteudo: bytes):
        raise AssertionError("Upload inválido não deve registrar documento.")
...
class AgendadorNaoUtilizado:
    def agendar_processamento(
        ...
        raise AssertionError("Upload inválido não deve agendar processamento.")
